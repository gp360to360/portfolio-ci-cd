      ...
      <div className="bg-[url('/src/assets/grid2.svg')] bg-cover bg-center bg-no-repeat h-full w-full flex flex-col items-center gap-4">
        ...
        <div className="flex flex-col md:flex-row gap-4 mt-auto w-full justify-between px-16 pb-8   items-center">
          ...
          <div className="flex gap-2 flex-row ">
            ...
            <a href="https://instagram.com/chouhanrahul1999" target="_blank" rel="noopener noreferrer" className="h-10 w-10 bg-radial from- from-40% to-[#161A31] backdrop-blur-sm border border-[#272A3C]/50 rounded-xl flex items-center justify-center hover:bg-[#05041F]/90 transition-all duration-300 shadow-lg">
              <FaInstagram size={18} color="white" />
            </a>
            <a href="https://linkedin.com/in/rahul-singh-8604b8221/" target="_blank" rel="noopener noreferrer" className="h-10 w-10 bg-radial from- from-40% to-[#161A31] backdrop-blur-sm border border-[#272A3C]/50 rounded-xl flex items-center justify-center hover:bg-[#05041F]/90 transition-all duration-300 shadow-lg">
              <FaLinkedin size={18} color="white" />
            </a>
            <a href="https://twitter.com/Rahulsingh90921" target="_blank" rel="noopener noreferrer" className="h-10 w-10 bg-radial from- from-40% to-[#161A31] backdrop-blur-sm border border-[#272A3]/50 rounded-xl flex items-center justify-center hover:bg-[#05041F]/90 transition-all duration-300 shadow-lg">
              <FaTwitter size={18} color="white" />
            </a>
            <a href="https://wa.me/+918271420880" target="_blank" rel="noopener noreferrer" className="h-10 w-10 bg-radial from- from-40% to-[#161A31] backdrop-blur-sm border border-[#272A3C]/50 rounded-xl flex items-center justify-center hover:bg-[#05041F]/90 transition-all duration-300 shadow-lg">
